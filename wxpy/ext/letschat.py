# coding: utf-8
# source copy from https://github.com/cathalgarvey/python-letschat
"""
...
class Room:
    def __init__(self, api, id, slug, name, description, created, lastActive, owner, private, hasPassword,participants):
        """
...
#wrapper the lets chat API
class LetsChat(API):

    def __init__(self, endpoint: str, token: str):
        API.__init__(self, endpoint, token)
